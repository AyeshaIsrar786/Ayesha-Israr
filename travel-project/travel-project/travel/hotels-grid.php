                            ...
                            <div class="tools-ber">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-5 hidden-xs text-right">
                                        ...
                                        <a href="hotels-grid.php" class="filters-btn"><i class="flaticon-squares-gallery-grid-layout-interface-symbol"></i></a>
                                        <a href="hotels-list.php" class="filters-btn"><i class="flaticon-bulleted-list"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="hotel-list-content">
                                <div class="row grid-margin">
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-1.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-2.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-3.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-4.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-5.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-6.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-7.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-8.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-9.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-10.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-11.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                <a href="#"><img src="assets/images/hotel-370x370-12.jpg" alt="1" class="img-responsive" /></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub>785</span>
                    ...
                    <div class="col-sm-4 col-md-3">
                        <div class="footer-box address-inner">
                            ...
                            <div class="address">
                                ...
                                <p> <a href="http://travel.bdtask.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4a2b2e2723240a2d272b232664292527">[email&#160;protected]</a></p>
                            </div>
                        </div>
                    </div>
